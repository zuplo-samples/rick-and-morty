...
curl -H "Authorization: Bearer YOUR_API_KEY" \
  "https://rickandmorty.zuplo.io/v1/characters"
```
...
curl -H "Authorization: Bearer YOUR_API_KEY" \
  "https://rickandmorty.zuplo.io/v1/characters/1,2,3"
```
...
curl -H "Authorization: Bearer YOUR_API_KEY" \
  "https://rickandmorty.zuplo.io/v1/characters?name=rick&status=alive&species=human"
```

```bash
# Find all dead characters
curl -H "Authorization: Bearer YOUR_API_KEY" \
  "https://rickandmorty.zuplo.io/v1/characters?status=dead"
```

```bash
# Find all Pickle-type characters (you know which one)
curl -H "Authorization: Bearer YOUR_API_KEY" \
  "https://rickandmorty.zuplo.io/v1/characters?name=pickle"
```
...
- [Locations Guide](/docs/locations) — where do these characters live?
- [Episodes Guide](/docs/episodes) — which episodes do they appear in?
- [API Reference](/docs/api) — try the Characters endpoints interactively
