...
<Callout type="tip">
New here? Head to the [Getting Started](/docs/getting-started) guide to get your API key and make your first request in under 2 minutes.
</Callout>
...
[Explore Characters →](/docs/characters)
...
- [Getting Started](/docs/getting-started) — sign up and make your first request
- [API Reference](/docs/api) — full interactive reference with try-it-out
